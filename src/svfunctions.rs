...
pub fn sv_buildflatbags(ss: Vec<&str>, mm: HashMap<String, Vec<String>>) -> Vec<String> {
...
pub fn sv_buildcompositebags(ss: Vec<&str>, mm: HashMap<String, Vec<String>>) -> Vec<String> {
...
pub fn sv_buildwinnertakesallbags(ss: Vec<&str>, parsemap: HashMap<String, Vec<String>>, pg: &mut postgres::Client) -> Vec<String> {
...
pub fn sv_dropstopwords(todrop: &str, bags: Vec<String>) -> Vec<String> {
